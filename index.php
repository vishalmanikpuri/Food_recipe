    ...
    <body>
        ...
        <header>
            <a href="#" class="logo" data-aos="fade-down"  data-aos-offset="300" data-aos-duration="3000">Food<span>.</span></a>
            <!-- <div class="menuToggle" onclick="toggleMenu();"></div> -->
            <ul class="navigation" data-aos="fade-down"
              ...
              <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
                ...
                <h2 class="ml9" >
                    <span class="text-wrapper">
                        <span class="letters" data-aos="fade-down" data-aos-duration="2500">Always Choose Good!</span>
                    </span>
                </h2>
                <p>
     ...
     data-aos-duration="2500" data-aos-offset="300">
     ...
     data-aos-duration="2500" data-aos-offset="300">
        ...
        <section class="about" id="about"  >
            <div class="row">
                <div class="col50" data-aos="fade-up-right" data-aos-duration="2500">
                    <h2 class="titleText" data-aos="zoom-in-up"><span>A</span>bout Us</h2>
                    <p>
     ...
     data-aos-easing="ease-in-sine" data-aos-duration="2500">
                    <div class="imgBx" data-aos="fade-left"  data-aos-duration="2500">
                        <!-- image hover -->
     ...
     data-aos-duration="2500">Our<span>M</span>enu</h2>
            ...
            <div class="content menu__box disp"  data-aos="zoom-in-up" data-aos-duration="2500">
                <?php
                if ($jsondata != '') {
     ...
     data-aos-anchor-placement="top-bottom" data-aos-duration="2500">
        ...
        <section class="expert" id="expert">
            <div class="title"  data-aos="fade-up"
     data-aos-duration="2500">
                <h2 class="titleText" data-aos="zoom-in-up">Our kitchen <span>E</span>xpert</h2>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
            </div>
            <div class="content">
                <div class="box">
                    <div class="imgBx" data-aos="zoom-in-up" data-aos-duration="2500">
		...
		<ul class="caption-style-1">
            ...
            <img src="img/expert1.jpg">
				<div class="caption">
                    ...
                    <div class="text" data-aos="fade-right" data-aos-duration="2500">
		...
		<ul class="caption-style-1">
            ...
            <img src="img/expert2.jpg">
				<div class="caption">
                    ...
                    <div class="text" data-aos="fade-up" data-aos-duration="2500">
                        <h3>Someone Famous</h3>
                    </div>
                </div>
<!-- ///////////////////////////////////// -->
		...
		<ul class="caption-style-1">
            ...
            <img src="img/expert3.jpg">
				<div class="caption">
                    ...
                    <div class="text"data-aos="fade-left" data-aos-duration="2500">
                        <h3>Someone Famous</h3>
                    </div>
                </div>
                <!-- ///////////////// -->
...
<div class="container-a1">
        ...
        <section class="testimonials" id="testimonials">
            <div class="title white">
                <h2 class="titleText" data-aos="fade-down" data-aos-duration="2500">They <span>S</span>aid About Us</h2>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
            </div>
            <div class="content" >
                <div class="box"  data-aos="fade-up-right" data-aos-duration="2500">
                    <div class="imgBx"  data-aos="zoom-in-down" data-aos-duration="2500">
                        <img src="img/testi1.jpg">
                    </div>
                    <div class="text" data-aos="zoom-in-right" data-aos-duration="2500">
                        <p>
                ...
                <div class="box"   data-aos="fade-up" data-aos-duration="2500">
                    ...
                    <div class="text" data-aos="zoom-in-up"data-aos-duration="2500">
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam illum nisi sit harum dolorem aliquam ipsum. Ex facere velit asperiores?
                        <h3>Someone Famous</h3>
                        </p>
                ...
                <!-- ///// -->
                <div class="box" data-aos="fade-up-left" data-aos-duration="2500">
                    <div class="imgBx"  data-aos="zoom-in-down" data-aos-duration="2500">
                        <img src="img/testi3.jpg">
                    </div>
                    <div class="text"data-aos="zoom-in-left" data-aos-duration="2500">
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam illum nisi sit harum dolorem aliquam ipsum. Ex facere velit asperiores?
                        <h3>Someone Famous</h3>
                        </p>
        ...
        <section class="contact" id="contact">
            <div class="title">
                <h2 class="titleText" data-aos="zoom-in" data-aos-duration="2500"><span>C</span>ontact Us</h2>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
            </div>
            <div class="contactForm"   >
                <h3>Send Message</h3>
                <form name="frmContact" id="frmContact" method="post" enctype="multipart/form-data"  action="./ContactusSubmission.php"  onsubmit = "return validateForm()" >
                    <div class="inputBox" >
                        <input type="text" name="user" id="user" placeholder="Enter Your Name*" required autocomplete="off" autofocus>

                        <span id="username" class="text-danger font-weieight-bold"></span>
                    </div>
                    <div class="inputBox" >
                    ...
                    <div class="inputBox">
                        <input type="text" name="Phone" id="phone" placeholder="Enter Your Phone number*" required autocomplete="off">
                    </div>

                    <div class="inputBox" >
                        <textarea placeholder="Enter Your Message Here*"  id="message" name="content" rows=6 required></textarea autocomplete="off">
                    </div>
                    <div class="inputBox"  >
